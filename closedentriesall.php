...
<body>
    ...
    <div class="header">
    <h3>All Closed Complaint Entries:</h3>
    </div>
  ...
  <tbody>
        <?php
            $selectquery = "SELECT * FROM closedentries";
        ...
        <tr>
            ...
            <td>
                <a href="deleteclosedcomplaints.php?del=<?php echo $res['id']?>">
                    <button class="btn btn-danger btn-sm">Delete</button>
                </a>
            </td>
            <td>
                <?php print nl2br( $res['exprogress'] ); ?>
                </form>
            </td>
        </tr> 
        <?php
